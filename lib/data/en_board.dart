...
//<editor-fold desc="Data Methods">
  ...
  @override
  String toString() {
    return 'EnBoard{' + ' $id_: $id,' + ' $boardTitle_: $boardTitle,' + ' $personName_: $personName,' + ' $mobilePhone_: $mobilePhone,' + ' $email_: $email,' + '}';
  }
  ...
  factory EnBoard.fromMap(MapDynamic map) {
    return EnBoard(
      id: map[id_] as int,
